 ...
 *
 */
$container['mongodb_default'] = function (\Slim\Container $container) {
    $config = \App\Base\AppContainer::config('mongodb_default');
    ...
    return $connection->getConnection('mongodb_default');
};
